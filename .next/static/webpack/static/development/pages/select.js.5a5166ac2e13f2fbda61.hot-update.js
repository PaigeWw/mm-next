...
/* harmony default export */ __webpack_exports__["default"] = (function (props) {
  ...
  var handleSelect = function handleSelect(item, type) {
    ...
    switch (type) {
      case "color":
        var _cIndex = colorList.findIndex(function (x) {
          return x.colorId === item.colorId;
        });

        colorList[_cIndex].selected = !colorList[_cIndex].selected; // colorList.splice(index, 1, item.selected=true)
...
//# sourceMappingURL=select.js.5a5166ac2e13f2fbda61.hot-update.js.map