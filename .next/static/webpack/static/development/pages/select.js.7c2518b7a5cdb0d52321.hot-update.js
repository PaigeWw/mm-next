...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  ...
  return __jsx(rebass__WEBPACK_IMPORTED_MODULE_3__["Flex"], {
    ...
    onClick: function onClick() {
      ...
      console.log(selectStyles); // console.log('selectStylesselectStylesselectStyles')

      if (selectStyles.length > 0) {
        next_router__WEBPACK_IMPORTED_MODULE_4___default.a.push("/made?id=".concat(selectStyles[0], "&id1=").concat(selectStyles.length > 1 ? selectStyles[1] : 0));
      } else {
...
//# sourceMappingURL=select.js.7c2518b7a5cdb0d52321.hot-update.js.map