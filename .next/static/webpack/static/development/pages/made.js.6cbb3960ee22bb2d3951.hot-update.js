      ...
      if (colors && colors.length > 0 && colors[0]) {
        for (var i = 0; i < svg.children.length; i++) {
          if (svg.children[i].tagName === "g" || svg.children[i].tagName === "path") {
            console.log(colors);
            svg.children[i].style.fill = colors[i].type ? "url(\"#".concat(id, "-").concat(colors[i]._id, "-").concat(i, "\")") : colors[i].value;
          }
        }
      }
    },
...
//# sourceMappingURL=made.js.6cbb3960ee22bb2d3951.hot-update.js.map