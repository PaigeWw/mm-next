  ...
  Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(function () {
    ...
    for (var i = 0; i < svgElement.children.length; i++) {
      if (svgElement.children[i].tagName === "g" || svgElement.children[i].tagName === "path") {
        svgElement.children[i].style.fill = colors[i].type ? "url(\"#".concat(styleId, "-").concat(colors[i]._id, "-").concat(i, "\")") : colors[i].value;
      }
    }
  }, [colors]);
  return __jsx("div", {
...
//# sourceMappingURL=made.js.45d64a2ea774144ac464.hot-update.js.map