...
/* harmony default export */ __webpack_exports__["default"] = (function (props) {
  var width = props.width,
      ...
      _props$imgValsAttrs = props.imgValsAttrs,
      imgValsAttrs = _props$imgValsAttrs === void 0 ? [] : _props$imgValsAttrs,
  ...
  return __jsx("div", {
    ...
    src: "".concat(_utils_helper__WEBPACK_IMPORTED_MODULE_2__["baseUrl"]).concat(shadowUrl),
    style: {
      width: width,
      position: "absolute",
      left: 0,
    ...
    beforeInjection: function beforeInjection(svg) {
      ...
      var _loop = function _loop(i) {
        ...
        if (color && color.type) {
          var imgVals = imgValsAttrs.find(function (x) {
            return x.colorId === color._id;
          }) || {
            scale: 1,
            x: 0,
            y: 0
          ...
          svgPatternImage.href.baseVal = "".concat(_utils_helper__WEBPACK_IMPORTED_MODULE_2__["baseUrl"]).concat(color.value); // editSvgs.svgDefs.appendChild(svgPattern)
    ...
    evalScripts: "always",
    src: "".concat(_utils_helper__WEBPACK_IMPORTED_MODULE_2__["baseUrl"]).concat(svgUrl),
    __source: {
      fileName: _jsxFileName,
      lineNumber: 35
    },
...
//# sourceMappingURL=mine.js.b4ea2634704216a4d635.hot-update.js.map