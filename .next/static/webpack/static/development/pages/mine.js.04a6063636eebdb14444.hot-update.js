...
/* harmony default export */ __webpack_exports__["default"] = (function (props) {
  ...
  var initData = selectStyles.map(function (x) {
    ...
    return {
      ...
      sizeInfo: sizeInfo,
      total: 0,
      signalPrice: x.details[0].price + x.details.length > 0 ? x.details[1].price : 0
    };
  });
  ...
  var getItemsTotalPrice = function getItemsTotalPrice(index) {
    if (index < orderData.length) {
      var count = orderData[index].sizeInfo.map(function (size) {});
    }
  };
  ...
  return __jsx(rebass__WEBPACK_IMPORTED_MODULE_8__["Flex"], {
    ...
    return __jsx(_base_table__WEBPACK_IMPORTED_MODULE_9__["TableLine"], {
      ...
      __self: this
    }, "10"), __jsx(rebass__WEBPACK_IMPORTED_MODULE_8__["Flex"], {
      flexDirection: "column",
      __source: {
        fileName: _jsxFileName,
        lineNumber: 129
...
//# sourceMappingURL=mine.js.04a6063636eebdb14444.hot-update.js.map