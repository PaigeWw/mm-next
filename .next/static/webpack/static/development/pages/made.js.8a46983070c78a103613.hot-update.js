...
/* harmony default export */ __webpack_exports__["default"] = (function (props) {
  ...
  var createSvgPattern = function createSvgPattern(svg, color) {
    if (!editSvgs.svgDefs) {
      editSvgs.svgDefs = document.createElementNS("http://www.w3.org/2000/svg", "defs"); //${index}-style-img-svg

      document.getElementById("mm-defs-svg").appendChild(editSvgs.svgDefs); // document.getElementById("0-style-img-svg").appendChild(editSvgs.svgDefs)
    }
...
//# sourceMappingURL=made.js.8a46983070c78a103613.hot-update.js.map