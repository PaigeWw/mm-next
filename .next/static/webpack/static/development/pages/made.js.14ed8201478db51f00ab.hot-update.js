...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  ...
  var handleConfirmMade = function handleConfirmMade(colors) {
    if (!colors[0]) return;
      ...
      return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              if (styleInitData[index][0].color) {
                _context2.next = 2;
                break;
              }
            ...
            case 2:
              ...
              params = [{
                ...
                colorIds: [styleInitData[index][0].color._id]
              }];
              ...
              if (styleInitData[index][1].color._id) {
                _context2.next = 9;
                break;
              }
            ...
            case 9:
              params.push({
                ...
                colorIds: [styleInitData[index][1].color._id]
              });
...
//# sourceMappingURL=made.js.14ed8201478db51f00ab.hot-update.js.map