  ...
  var handleSelect = function handleSelect(item, type) {
    switch (type) {
      case "color":
        ...
        colorList[cIndex].selected = true; // colorList.splice(index, 1, item.selected=true)
      ...
      case "paint":
        ...
        paintList[cIndex].selected = true; // colorList.splice(index, 1, item.selected=true)
...
//# sourceMappingURL=select.js.54eb8dae405837ebb54d.hot-update.js.map