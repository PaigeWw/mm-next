      ...
      if (colors && colors.length > 0 && colors[0]) {
        for (var i = 0; i < svg.children.length; i++) {
          if (svg.children[i].tagName === "g" || svg.children[i].tagName === "path") {
            console.log(colors);
            svg.children[i].style.fill = colors[0].type ? "url(\"#".concat(id, "-").concat(colors[i]._id, "-").concat(i, "\")") : colors[i].value;
          }
        }
      }
    },
...
//# sourceMappingURL=made.js.2fcfd4f7e6dd7cc52c1c.hot-update.js.map