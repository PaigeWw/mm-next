...
/* harmony import */ var _components_commons_style_img__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../components/commons/style-img */ "./components/commons/style-img.js");
...
/* harmony import */ var _color_and_paint__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./color-and-paint */ "./components/color-and-paint.js");
/* harmony import */ var _utils_request_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../utils/request.js */ "./utils/request.js");
...
/* harmony default export */ __webpack_exports__["default"] = (function (props) {
  ...
  var editSvgs = {};
  var editPatterns = {};
  var tempSelectedIds = [curStyle[0].color]; // let tempSelectedImgs = [curStyle[0].imgUrl]

  if (curStyle.length > 1) {
    tempSelectedIds.push(curStyle[1].color); // tempSelectedImgs.push(curStyle[1].imgUrl)
  } else {
    tempSelectedIds.push(false); // tempSelectedImgs.push(false)
  }
  ...
  var _useState2 = Object(react__WEBPACK_IMPORTED_MODULE_3__["useState"])(0),
      ...
      setCurStyleIndex = _useState2[1]; // const [curStyleImgs, setCurStyleImgs] = useState(tempSelectedImgs)


  var _useState3 = Object(react__WEBPACK_IMPORTED_MODULE_3__["useState"])({
    docs: []
  }),
      plainColors = _useState3[0],
      setPlainColors = _useState3[1];

  var _useState4 = Object(react__WEBPACK_IMPORTED_MODULE_3__["useState"])({
    docs: []
  }),
      flowerColors = _useState4[0],
      setFlowerColors = _useState4[1]; // const [colorList, setColorList] = useState(styleDetails[0].plainColors)
      ...
      return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return Object(_utils_request_js__WEBPACK_IMPORTED_MODULE_9__["default"])("color/getList", {
                type: 0,
                page: page,
                limit: 14
              }, "get");
  ...
  var createSvgPattern = function createSvgPattern(svg, color) {
    ...
    if (!editPatterns[color._id]) {
      ...
      svgPatternImage.href.baseVal = "".concat(_utils_helper__WEBPACK_IMPORTED_MODULE_10__["baseUrl"]).concat(color.value);
  ...
  var selectFlowerColor = function selectFlowerColor(color, svgId) {
    ...
    // 	) {
    // 		svg.children[i].style.fill = `url("#${color._id}")`
    // 	}
    // }
  ...
  var handleSelect = function handleSelect(item, type) {
    ...
    if (item._id === curSelectedColors[curStyleIndex]) {
      ...
      setCurSelectedColors([].concat(curSelectedColors)); // curStyleImgs.splice(curStyleIndex, 1, false)
      ...
      switch (type) {
        case "color":
          ...
          var _svg2 = getEditSvgById(cIndex); // let section = document.getElementById("section")
          // section.innerHTML = "hhhhhh"


          for (var i = 0; i < _svg2.children.length; i++) {
            if (_svg2.children[i].tagName === "g" || _svg2.children[i].tagName === "path") {
              _svg2.children[i].style.fill = item.value;
              console.log(_svg2.children[i]); // svg.removeChild(svg.children[i])
            }
          }
        ...
        return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                _context3.next = 2;
                return Object(_utils_request_js__WEBPACK_IMPORTED_MODULE_9__["default"])("channel/getAssign", {
                  styleId: styleId,
                  channelId: channelId
                }, "get");
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_3__["useEffect"])(function () {}, []);
  return __jsx(_modal__WEBPACK_IMPORTED_MODULE_7__["default"], {
    ...
    return __jsx(rebass__WEBPACK_IMPORTED_MODULE_6__["Flex"], {
      ...
      __self: this
    }, __jsx(_components_commons_style_img__WEBPACK_IMPORTED_MODULE_5__["default"], {
      width: "3.79rem",
      color: curSelectedColors[curStyleIndex],
      svgId: style._id,
    ...
    __self: this
  }, __jsx(rebass__WEBPACK_IMPORTED_MODULE_6__["Text"], {
    id: "section",
    fontSize: "0.18rem",
    fontWeight: "bolder",
    __source: {
    ...
    __self: this
  }, "SECTION NUMBER"), __jsx(rebass__WEBPACK_IMPORTED_MODULE_6__["Text"], {
    fontSize: "0.1rem",
    m: "0.16rem 0",
    __source: {
      fileName: _jsxFileName,
    ...
    __self: this
  }, styleDetails[curStyleIndex].styleNo)), __jsx(_color_and_paint__WEBPACK_IMPORTED_MODULE_8__["ColorList"], {
    ...
    __self: this
  }), __jsx(_color_and_paint__WEBPACK_IMPORTED_MODULE_8__["PaintList"], {
...
//# sourceMappingURL=made.js.59ef3a5a4588f22ae219.hot-update.js.map