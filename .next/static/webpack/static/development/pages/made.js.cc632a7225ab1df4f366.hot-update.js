      ...
      switch (type) {
        case "color":
          ...
          for (var i = 0; i < svg.childNodes.length; i++) {
            if (svg.childNodes[i].tagName === "g" || svg.childNodes[i].tagName === "path") {
              svg.childNodes[i].style.fill = item.value;
              console.log(svg.childNodes[i]);
            }
          }
...
//# sourceMappingURL=made.js.cc632a7225ab1df4f366.hot-update.js.map