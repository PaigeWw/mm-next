...
/* harmony default export */ __webpack_exports__["default"] = (function (props) {
  ...
  var handleSelect = function handleSelect(item, type) {
    ...
    var curChannelInfo = cIndex >= 0 ? channelInfoList[cIndex] : {};
    ...
    switch (type) {
      case "color":
        ...
        var _cIndex = curChannelInfo.plainColorIds.indexOf(item.colorId);

        if (_cIndex < 0) {
          curChannelInfo.plainColorIds.push(item.colorId);
        } else {
          curChannelInfo.plainColorIds.splice(_cIndex, 1);
      ...
      case "paint":
        var pIndex = colorList.indexOf(item.colorId);
...
//# sourceMappingURL=select.js.fa08d11fbcee315d4453.hot-update.js.map