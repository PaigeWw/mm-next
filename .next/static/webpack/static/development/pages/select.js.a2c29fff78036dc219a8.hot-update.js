...
var ColorList = function ColorList(props) {
  ...
  var usedPlainColorIds = channelInfoList[cIndex].plainColorIds;
  return __jsx(rebass__WEBPACK_IMPORTED_MODULE_1__["Box"], {
    width: "100%",
    mb: "0.4rem",
    __source: {
    ...
    return __jsx(rebass__WEBPACK_IMPORTED_MODULE_1__["Box"], {
      sx: {
        ...
        border: "1px ".concat(item.selected || usedPlainColorIds.findIndex(function (id) {
...
//# sourceMappingURL=select.js.a2c29fff78036dc219a8.hot-update.js.map