...
var ColorList = function ColorList(props) {
  var colorList = props.colorList,
      ...
      curChannelIndex = props.curChannelIndex; // let curChannelId = channelList[curChannelId]._id

  var cIndex = channelInfoList.findIndex(function (x) {
    return x._id === curChannelId;
  });
  var curChannelInfo = channelInfoList[cIndex];
  return __jsx(rebass__WEBPACK_IMPORTED_MODULE_1__["Box"], {
    width: "100%",
    mb: "0.4rem",
    __source: {
...
//# sourceMappingURL=select.js.2c6a717a0d5f073a57a2.hot-update.js.map