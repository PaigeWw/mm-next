...
/* harmony default export */ __webpack_exports__["default"] = (function (props) {
  ...
  var _useState = Object(react__WEBPACK_IMPORTED_MODULE_7__["useState"])(initData),
  ...
  var handleChangeOrder = function handleChangeOrder(styleIndex, sizeIndex, num) {
    console.log(num);
    if (num < 0) return;
    orderData[styleIndex].sizeInfo[sizeIndex].num = num;
    orderData[styleIndex].total = getItemsTotalPrice(styleIndex) * packageCount;
    setOrderData([].concat(orderData));
    console.log("orderData", orderData);
  };

  var getItemsTotalPrice = function getItemsTotalPrice(index) {
  ...
  return __jsx(rebass__WEBPACK_IMPORTED_MODULE_8__["Flex"], {
    ...
    return __jsx(_base_table__WEBPACK_IMPORTED_MODULE_9__["TableLine"], {
      ...
      __self: this
    }, index), __jsx(_base_table__WEBPACK_IMPORTED_MODULE_9__["ProductInfo"], {
      ...
      __self: this
    }, __jsx(_base_table__WEBPACK_IMPORTED_MODULE_9__["ProductInfo"], {
      made: "2110 YE GREEN",
      __source: {
        fileName: _jsxFileName,
        lineNumber: 78
      ...
      __self: this
    })), __jsx(_show_style__WEBPACK_IMPORTED_MODULE_10__["default"], {
      key: collect.id,
      imgWidth: "0.95rem",
      mode: "POSITIVE",
      ...
      return __jsx(rebass__WEBPACK_IMPORTED_MODULE_8__["Flex"], {
        ...
        __self: this
      }, size.name), __jsx(_number_input__WEBPACK_IMPORTED_MODULE_11__["default"], {
    ...
    })), index > 0 ? null : __jsx(rebass__WEBPACK_IMPORTED_MODULE_8__["Flex"], {
      rowspan: line,
      hasBorder: "1px solid",
      ...
      __self: this
    }, __jsx(_number_input__WEBPACK_IMPORTED_MODULE_11__["default"], {
      __source: {
        fileName: _jsxFileName,
        lineNumber: 130
      },
      ...
      __self: this
    }, orderData[index].total), __jsx(rebass__WEBPACK_IMPORTED_MODULE_8__["Flex"], {
      flexDirection: "column",
      __source: {
        fileName: _jsxFileName,
        lineNumber: 135
      ...
      __self: this
    }, orderData[index].signalPrice + orderData[index].total));
...
//# sourceMappingURL=mine.js.4b7533f8bfa7618f7643.hot-update.js.map