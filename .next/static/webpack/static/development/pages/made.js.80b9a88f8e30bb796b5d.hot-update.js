  ...
  Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(function () {
    ...
    for (var i = 0; i < svgElement.children.length; i++) {
      if (svgElement.children[i].tagName === "g" || svgElement.children[i].tagName === "path" && j < colors.length) {
        svgElement.children[i].style.fill = colors[i].type ? "url(\"#".concat(styleId, "-").concat(colors[j]._id, "-").concat(i, "\")") : colors[j].value;
        j++;
      }
    }
  }, [colors]);
...
//# sourceMappingURL=made.js.80b9a88f8e30bb796b5d.hot-update.js.map