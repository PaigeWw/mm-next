          ...
          switch (_context.prev = _context.next) {
            ...
            case 5:
              ...
              data = res.map(function (order) {
                var orderData = order.orderData; // let threeViewsList = []

                var styleList = [];
                var quantity = 0;
                var price = 0;
                orderData.map(function (item) {
                  item.favorite.styleAndColor.map(function (x) {
                    styleList.push({
                      style: x.style,
                      colors: x.colorIds
                  ...
                  quantity += item.total;
                  price += item.totalPrice; // threeViewsList.push(threeViews)
                });
                return {
                  quantity: quantity,
                  price: price,
...
//# sourceMappingURL=mine.js.c879816d36ddd0aca1bb.hot-update.js.map